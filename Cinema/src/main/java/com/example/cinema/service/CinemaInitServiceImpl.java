...
private SalleRepository salleRepository;
    ...
    public void initVilles(){
        Stream.of("Casablanca","Marrakech","Agadir","Tanger").forEach(nameVille->{
    ...
    public void initCinemas(){
        villeRepository.findAll().forEach(v->{
            Stream.of("Megarama","IMax","Chahrazad","Founoun").forEach(nameCinema->{
    ...
    public void initFilms(){
        ...
        Stream.of("Interstellar", "Inception", "Shutter island", "Coherence").forEach(filmTitre -> {
            Film film = new Film();
